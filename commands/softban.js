...
sql.open("./SQL/settingsguildsettings.sqlite");
exports.run = (client, message, args) => {
  ...
  const usage = new Discord.RichEmbed()
            ...
            .addField("Example", prefixtouse + "softban @Someone bad boi")
            .setDescription("Description: " + "Bans and unbans a user from the server");
