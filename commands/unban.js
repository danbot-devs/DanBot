...
exports.run = (client, message, args) => {
  ...
  const usage = new Discord.RichEmbed()
            ...
            .addField("Example", prefixtouse + "unban 137624084572798976 wanted a unban <3")
     ...
     if (user === message.author.id) return message.channel.send(`:x: You can't unban yourself`);
