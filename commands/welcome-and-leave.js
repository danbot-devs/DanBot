...
exports.run = (client, message, args) => {
    ...
    sql.get(`SELECT * FROM scores WHERE guildId ="${message.guild.id}"`).then(row => {
     ...
     const embed10 = new Discord.RichEmbed()
        ...
        .setTitle("Command: " + prefixtouse + "welcome-and-leave")
	    .addField("Usage", prefixtouse + "welcome-and-leave [number] [text]")
        ...
        .addField("Example", prefixtouse + "welcome-and-leave 3 Welcome to %GUILDNAME%, %MENTION% has joined us.")
